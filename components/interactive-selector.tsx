...
const InteractiveSelector = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-#6A687A font-sans text-white"> 
      {/* Header Section */}
      <motion.div
             ...
             >
               ...
               <h2 className="font-serif text-3xl md:text-4xl font-bold text-foreground mb-4">Our Trip Styles</h2>
      ...
      {/* Options Container */}
      <div className="options  rounded-4xl flex w-full max-w-[900px] min-w-[600px] h-[400px] mx-0 items-stretch overflow-hidden relative">
        {options.map((option, index) => (
          <div
            key={index}
            className={`
              option relative flex rounded-4xl  flex-col justify-end overflow-hidden transition-all duration-700 ease-in-out
